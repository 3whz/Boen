...
//联表
    ...
    @Results({
            ...
            @Result(column = "id", property = "gymClass",
                    many = @Many(
                            select = "com.boen.mapper.GymClassMapper.GymClassByUIdSelect",
    ...
    @Results({
            ...
            @Result(column = "id", property = "gymClass",
                    many = @Many(
                            select = "com.boen.mapper.GymClassMapper.GymClassByCUIdSelect",
                            fetchType = FetchType.LAZY
                    )
            )
    })
    ...
    public User UserByUIdSelect(int u_id);
